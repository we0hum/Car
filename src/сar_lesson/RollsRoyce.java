...
public class RollsRoyce extends Car {
    ...
    public RollsRoyce(int motorPower, String motor, int doors, String gearBox, int horsePower, String nameModel) {
        super(motorPower, motor, doors, gearBox, horsePower);
        this.color = "Значение отсутствует";
        this.nameModel = nameModel;
    }

    public RollsRoyce(int motorPower, String motor, int doors, String gearBox, String color, int horsePower) {
        super(motorPower, motor, doors, gearBox, horsePower);
        this.color = color;
        this.nameModel = "Значение отсутствует";
    }

    public RollsRoyce(int motorPower, String motor, int doors, String gearBox, int horsePower) {
        super(motorPower, motor, doors, gearBox, horsePower);
        this.color = "Значение отсутствует";
        this.nameModel = "Значение отсутствует";
    }
